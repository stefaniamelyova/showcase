...
const BentoCardGrid: React.FC<{
  ...
  <div
    className="bento-section grid gap-2 p-3 max-w-[400rem] select-none relative"
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2">
          {(cards || cardData).map((card, index) => {
            const baseClassName = `card flex flex-col justify-between relative aspect-[4/3] min-h-[400px] min-w-[300px]  max-w-full p-2 rounded-[10px] border border-solid font-light overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)]  bg-[rgba(255,255,255,0.06)] backdrop-blur-md ${
