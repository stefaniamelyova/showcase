...
const SplitText: React.FC<SplitTextProps> = ({
  ...
  // Initialize state lazily to avoid synchronous update in useEffect
  const [fontsLoaded, setFontsLoaded] = useState(() => {
    if (typeof document === "undefined" || !document.fonts) {
      return true; // Assume loaded on server or in unsupported browser
    }
    return document.fonts.status === "loaded";
  });

  useEffect(() => {
    // If fonts were not loaded initially, wait for them
    if (!fontsLoaded) {
      let isMounted = true;
